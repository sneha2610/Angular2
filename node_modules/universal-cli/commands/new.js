...
var NewCommand = Command.extend({
    ...
    run: function (commandOptions, rawArgs) {
        ...
        if (!packageName) {
            return Promise.reject(new SilentError(("The \"ung " + this.name + "\" command requires a name argument to be specified. ") +
        ...
        if (packageName === '.') {
            return Promise.reject(new SilentError("Trying to generate an application structure in this directory? Use \"ung init\" " +
                "instead."));
        }
...
//# sourceMappingURL=/home/david/angular-cli/packages/universal-cli/commands/new.js.map