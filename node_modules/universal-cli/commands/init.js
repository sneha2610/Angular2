...
var InitCommand = Command.extend({
    ...
    run: function (commandOptions, rawArgs) {
        ...
        this.project.addons = this.project.addons.filter(function (addon) {
            if (_this.analytics.version === undefined) {
                return true;
            }
            return addon.pkg.version === _this.analytics.version;
        });
        ...
        if (!packageName) {
            var message = 'The `ung ' + this.name + '` command requires a ' +
...
//# sourceMappingURL=/home/david/angular-cli/packages/universal-cli/commands/init.js.map