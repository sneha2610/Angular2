...
var GenerateCommand = EmberGenerateCommand.extend({
    ...
    beforeRun: function (rawArgs) {
        ...
        if (!rawArgs[1]) {
            SilentError.debugOrThrow('universal-cli/commands/generate', "The `ung generate " + rawArgs[0] + "` command requires a name to be specified.");
        }
...
//# sourceMappingURL=/home/david/angular-cli/packages/universal-cli/commands/generate.js.map