...
var package_chunk_sort_1 = require('../plugins/package-chunk-sort');
...
function getWebpackCommonConfig(projectRoot, environment, appConfig, baseHref, sourcemap, vendorChunk, verbose, progress) {
    ...
    var entryName = path.basename(appMain).replace('.ts', '');
    var extraPlugins = [];
    var extraRules = [];
    var lazyChunks = [];
    var entryPoints = {};
    ...
    if (appConfig.scripts.length > 0) {
        ...
        extraRules.push({
            include: globalScrips.map(function (script) { return script.path; }), test: /\.js$/, loader: 'script-loader'
        });
    }
    ...
    return {
        ...
        plugins: [
            new HtmlWebpackPlugin({
                ...
                chunksSortMode: package_chunk_sort_1.packageChunkSort([
...
//# sourceMappingURL=/home/david/angular-cli/packages/universal-cli/models/webpack-build-common.js.map