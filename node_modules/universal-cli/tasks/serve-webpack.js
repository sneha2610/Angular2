...
var universal_dev_server_1 = require('./server/universal-dev-server');
var url = require('url');
var opn = require('opn');
...
exports.default = Task.extend({
    run: function (serveTaskOptions) {
        var ui = this.ui;
        var webpackCompiler;
        var configs = new webpack_config_1.NgCliWebpackConfig(this.project, serveTaskOptions.target, serveTaskOptions.environment, undefined, undefined, serveTaskOptions.i18nFile, serveTaskOptions.i18nFormat, serveTaskOptions.locale, serveTaskOptions.aot, serveTaskOptions.sourcemap, serveTaskOptions.vendorChunk, serveTaskOptions.verbose, serveTaskOptions.progress).configs;
        ...
        if (appConfig.universal === false) {
            (_b = configs[0].entry.main).unshift.apply(_b, entryPoints);
        }
        ...
        if (appConfig.universal === true) {
            ...
            server = new universal_dev_server_1.UniversalDevServer(webpackCompiler, webpackDevServerConfiguration);
        }
        else {
            ui.writeLine(chalk.green((_d = ["\n      **\n      NG Live Development Server is running on\n      http", "://", ":", ".\n      **\n    "], _d.raw = ["\n      **\n      NG Live Development Server is running on\n      http", "://", ":", ".\n      **\n    "], common_tags_1.oneLine(_d, serveTaskOptions.ssl ? 's' : '', serveTaskOptions.host, serveTaskOptions.port))));
...
//# sourceMappingURL=/home/david/angular-cli/packages/universal-cli/tasks/serve-webpack.js.map